  ...
  return (
    <>
      ...
      <button
        ...
        onClick={onSoloAnio}
        className={cn(
          "w-full py-1.5 rounded-md text-xs font-medium transition-colors cursor-pointer border",
          anioEsSeleccionado
            ? "bg-blue-600 text-white border-blue-600"
            : "text-zinc-500 dark:text-zinc-400 border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-zinc-700 dark:hover:text-zinc-200",
        )}
      >
        Solo {anioVisible}
      </button>
